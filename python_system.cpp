...
void python_create_venv(const std::string &python_venv_path) {
    ...
    if (fs::exists(python_venv_path))
        fs::remove(python_venv_path);
...
bool python_pip_install(const std::string &python_venv_path, const std::string &requirements_file_path) {
    ...
    const string pip_executable_file_path =
            python_venv_path + string("/") + string("Scripts") + string("/") + string("pip.exe");
    const string python_pip_install_command = pip_executable_file_path + string(" ") + string("install -r") +
                                              string(" ") + string(requirements_file_path);
